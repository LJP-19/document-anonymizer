...
INLINE_LABELS = {
    ...
    # Full words of "social security number" / "your" - a form field's own
    # label wording, seen split across an inline label+value line. "security"
    # was not in this list and got absorbed into a widened SSN value.
    "social", "security", "your", "spouse's", "taxpayer's", "your's",
    "employer's", "your identification", "identification", "federal",
}
