...
def _self_test() -> int:
    ...
    """
    print("Self-test: loading the detection pipeline inside this frozen build...")
    try:
        import spacy
        ...
        if "PERSON" not in found:
            print(f"FAIL: model loaded but found no PERSON entity (got: {found})")
            return 1
        print("  spaCy + en_core_web_trf: OK")
    ...
    print("Self-test PASSED - the frozen build's detection pipeline works.")
    return 0
