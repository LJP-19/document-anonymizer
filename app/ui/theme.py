...
QPushButton:hover  {{ background: {SURFACE_3}; border-color: {TEXT_FAINT}; }}
...
QPushButton#Primary:pressed {{ background: {ACCENT}; padding-top: 8px; padding-bottom: 6px; }}
...
#Card:hover {{ border-color: {TEXT_DIM}; background: {SURFACE_3}; }}
...
QTableWidget::item:selected {{{{ background: {{ACCENT}}; color: #0b0e14; }}}}
"""
