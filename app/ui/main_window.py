...
class DocumentTab(QWidget):
    ...
    def _final_review_sidebar(self) -> QWidget:
        ...
        self.process_here_button = QPushButton("Process approved \u2192")
    ...
    def rebuild_final_list(self) -> None:
        ...
        for i in reversed(range(self.final_list_layout.count() - 1)):
            item = self.final_list_layout.itemAt(i)
    ...
    def on_undo_requested(self, page_no: int, rect: tuple) -> None:
        ...
        matches = [
            c for c in self.session.candidates
            if c.page_no == page_no and c.rect == rect
        ]
        if not matches:
            return
...
class MainWindow(QMainWindow):
    ...
    def process(self) -> None:
        ...
        if pending_review:
            ...
            QMessageBox.information(
                self, "Final review first",
                "Take a last look before writing the file. Press \u201cProcess "
                "approved \u2192\u201d in this panel when you are ready.",
            )
            return
