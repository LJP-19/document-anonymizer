...
def build_plan(
    ...
    for candidate in detection.candidates:
        ...
        elif candidate.household and candidate.pii_type is PiiType.PERSON:
            from ..pseudonymization.generator import generate_for_household

            replacement = generate_for_household(
                candidate.normalized, candidate.household, registry.scope
            )
            registry.override(candidate.pii_type, candidate.normalized, replacement)
        else:
