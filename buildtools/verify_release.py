...
REQUIRED = [
    ...
    "app/detection/second_pass.py",
    "app/detection/provider_shim.py",
    "app/ui/dialogs.py",
    "buildtools/verify_bundle.py",
...
MARKERS = {
    ...
    "app/session.py": ["add_manual_text", "add_manual_region", "find_text", "roster"],
    ...
    "app/ui/main_window.py": [
        "ProcessingView", "progress_reported", "search_and_blackout", "on_region_drawn",
    ],
